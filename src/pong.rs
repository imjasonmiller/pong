...
fn initialize_camera(world: &mut World) {
    // Setup camera in way that our screen covers the whole arena and (0, 0) is in the bottom left
...
fn initialize_paddles(world: &mut World, sprite_sheet: Handle<SpriteSheet>) {
    ...
    // Assgn the sprites for the paddles
...
/// ScoreBoard contains the actuals core data
#[derive(Default)]
...
/// ScoreText contains the ui text component that display the score
...
fn load_sprite_sheet(world: &mut World) -> Handle<SpriteSheet> {
    ...
    loader.load(
        "texture/pong_spritesheet.ron", // Here we load the associated file
